...
export const INITIAL_DISCUSSIONS: DiscussionThread[] = [
  {
    id: "thr-1",
    authorName: "Ust. Ahmad Fauzi, S.Pd.",
    authorRole: "teacher",
    authorClass: "Guru Pengampu",
    title: "📌 Pengumuman: Persiapan Simulasi TKA Bab Aljabar & Fungsi",
    content: "Assalamu'alaikum siswa-siswi Kelas 11 MA Darunnajah 9. Pekan depan kita akan mengadakan simulasi kuis berjangka waktu di Distrik 1 dan 2. Silakan tanyakan materi yang masih belum dipahami di thread ini.",
    category: "Pengumuman",
    repliesCount: 8,
    upvotes: 24,
  ...
  },
  {
    ...
    authorRole: "student",
    authorClass: "Kelas 11 A",
    title: "Trik cepat mencari invers matriks 3x3 metode kofaktor?",
    content: "Apakah ada cara cepat untuk menghitung adjoin matriks 3x3 selain menuliskan 9 kofaktor satu per satu saat ujian TKA nanti?",
    category: "Aljabar",
    repliesCount: 4,
    upvotes: 12,
    createdAt: "Hari ini, 09:15",
  },
];
